          ...
          <div class="col-md-12">
              <div class="breadcrumb-box text-center">
                  <ul class="list-unstyled list-inline">
                      <li class="list-inline-item" style="float: left"><a href="{{route('shopview') }}"><i class="fas fa-arrow-left"></i>Back</a></li>
                      <li class="list-inline-item"><a href="{{route('home') }}">Home</a></li>
                      <li class="list-inline-item"><span>||</span> Shop Products</li>
                  </ul>
              </div>
          </div>
      </div>
