...
<div class="ps-page--single">
  <div class="ps-breadcrumb">
      <div class="container">
          ...
          <li><a href="{{ route('home')}}">Home</a></li>
              <li>Sell on Procure</li>
          </ul>
      </div>
  </div>
  <div class="ps-vendor-banner bg--cover" data-background="{{ asset('images/new/pro/vendor/vendor.jpg')}}">
      <div class="container">
      <h2>Millions Of Shoppers Can’t Wait To See What You Have In Store</h2><a class="ps-btn ps-btn--lg" href="{{route('shop.new')}}">Start Selling</a>
      </div>
  </div>
              ...
              <div class="row">
                  <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                      <div class="ps-block--icon-box-2">
                          <div class="ps-block__thumbnail"><img src="{{ asset('images/new/pro/vendor/vendor-1.png')}}" alt=""></div>
                  ...
                  <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                      <div class="ps-block--icon-box-2">
                          <div class="ps-block__thumbnail"><img src="{{ asset('images/new/pro/vendor/vendor-2.png')}}" alt=""></div>
                          <div class="ps-block__content">
                  ...
                  <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                      <div class="ps-block--icon-box-2">
                          <div class="ps-block__thumbnail"><img src="{{ asset('images/new/pro/vendor/vendor-3.png')}}" alt=""></div>
                          <div class="ps-block__content">
                              <h4>Support 24/7</h4>
                              <div class="ps-block__desc" data-mh="about-desc">
                                  <p>Our tools and services make it easy to manage, promote and grow your business.</p>
      ...
      <div class="container">
          ...
          <div class="ps-section__content">
              <div class="ps-block--vendor-milestone">
                  ...
                  <div class="ps-block__right"><img src="{{ asset('images/new/pro/vendor/milestone-1.png')}}" alt=""></div>
              ...
              <div class="ps-block--vendor-milestone reverse">
                  ...
                  <div class="ps-block__right"><img src="{{ asset('images/new/pro/vendor/milestone-2.png')}}" alt=""></div>
              ...
              <div class="ps-block--vendor-milestone">
                  <div class="ps-block__left">
                      ...
                      <ul>
                          <li>Register your business for free and create a product catalogue. Get free training on how to run your online business</li>
                          <li>Our Procure Advisors will help you at every step and fully assist you in taking your business online</li>
                      </ul>
                  </div>
                  <div class="ps-block__right"><img src="{{ asset('images/new/pro/vendor/milestone-3.png')}}" alt=""></div>
              ...
              <div class="ps-block--vendor-milestone reverse">
                  ...
                  <div class="ps-block__right"><img src="{{ asset('images/new/pro/vendor/milestone-4.png')}}" alt=""></div>
  ...
  <div class="ps-section--vendor ps-vendor-best-fees">
      <div class="container">
          <div class="ps-section__header">
              <p>NO FEES TO START</p>
              <h4>Affordable, transparent, and secure</h4>
          </div>
          <div class="ps-section__content">
              <h5>It doesn’t cost a thing to list up to items, you only pay after your stuff sells. It’s just a small percent of the money you earn</h5>
              ...
              <div class="ps-section__desc">
                  <figure>
                      ...
                      <ul>
                          <li>A community of shoppers.</li>
                          <li>Great advertising advantage</li>
              ...
              <div class="ps-section__highlight"><img src="{{ asset('img/icons/vendor-4.png')}}" alt="">
                  <figure>
                      <p>We process payments with different payment methods. Funds from sales on Procure will be deposited into your registered account.</p>
                  </figure>
              </div>
  ...
  <div class="ps-vendor-banner bg--cover" data-background="{{ asset('images/new/pro/vendor/vendor.jpg')}}">
      <div class="container">
      <h2>It's time to start making money.</h2><a class="ps-btn ps-btn--lg" href="{{route('shop.new')}}">Start Selling</a>
      </div>
  </div>
</div>
